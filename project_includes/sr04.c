...
void interruptTimeOut_HWI(void)
{
...
void configTimeOut()
{
    ...
    TimerConfigure(TIMER1_BASE, (TIMER_CFG_SPLIT_PAIR | TIMER_CFG_A_PERIODIC_UP | TIMER_CFG_B_PERIODIC));

    TimerPrescaleSet(TIMER1_BASE, TIMER_B, 0xff);

    TimerLoadSet(TIMER1_BASE, TIMER_B, 160E3);

    TimerIntEnable(TIMER1_BASE, TIMER_TIMB_TIMEOUT);

    // Timer 1B interrupt enable (vector 38)
