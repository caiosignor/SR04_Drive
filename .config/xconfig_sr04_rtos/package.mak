...
override PKGDIR = xconfig_sr04_rtos
...
package/%.xdc.inc package/%_xconfig_sr04_rtos.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_sr04_rtos" (because $@ is older than $(firstword $?))" ...
...
.PHONY: release,xconfig_sr04_rtos
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_sr04_rtos.tar.dep
endif
package/rel/xconfig_sr04_rtos/xconfig_sr04_rtos/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_sr04_rtos/xconfig_sr04_rtos/package/package.rel.xml: package/build.cfg
package/rel/xconfig_sr04_rtos/xconfig_sr04_rtos/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_sr04_rtos/xconfig_sr04_rtos/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_sr04_rtos.tar: package/rel/xconfig_sr04_rtos.xdc.inc package/rel/xconfig_sr04_rtos/xconfig_sr04_rtos/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_sr04_rtos.xdc.inc,package/rel/xconfig_sr04_rtos.tar.dep)


release release,xconfig_sr04_rtos: all xconfig_sr04_rtos.tar
clean:: .clean
	-$(RM) xconfig_sr04_rtos.tar
	-$(RM) package/rel/xconfig_sr04_rtos.xdc.inc
	-$(RM) package/rel/xconfig_sr04_rtos.tar.dep
